                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <select name="genres[]" id="categories" class="form-control" multiple>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input
                                                class="form-control"
                                                type="text"
                                                placeholder="Enter genre special price"
                                                id="special_price"
                                                name="special_price"
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input
                                                ...
                                                type="number"
                                                placeholder="Enter film quantity"
                                                id="quantity"
                                                name="quantity"
                                                value="{{ old('quantity') }}"
                                            />
