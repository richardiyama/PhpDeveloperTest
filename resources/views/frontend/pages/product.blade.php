                                    ...
                                    <div class="mb-3">
                                        ...
                                        @else
                                            <var class="price h3 text-success">
                                               <span class="num" id="productPrice">{{ $film->price }}</span>
                                            </var>
                                        @endif
                                    </div>
                                    <hr>
                                            ...
                                            <div class="col-sm-12">
                                                <dl class="dlist-inline">
                                                    ...
                                                    <dd>
                                                        ...
                                                        <input type="hidden" name="productId" value="{{ $film->id }}">
    ...
    <script>
        $(document).ready(function () {
            ...
            $('.option').change(function () {
                $('#productPrice').html("{{ $film->sale_price != '' ? $film->sale_price : $film->price }}");
